...
router.route("/register").post(validate(signupSchema),authcontrollers.register); // POST request to the "/register" route handled by the register controller function
